 ...
 * @property {string} [noRepoLabel] - (optional) Override the fallback text shown when there's no repoUrl (defaults to "Private · Available on request"), for cases where the repo isn't mine to share
...
export const projects = [
  ...
  },
  {
    ...
    noRepoLabel: "Owned by Depole.io, code not mine to share",
    screenshots: [
